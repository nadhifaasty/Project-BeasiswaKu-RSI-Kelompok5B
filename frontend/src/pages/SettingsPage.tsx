    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card className="p-6 space-y-6">
        <div className="flex items-center gap-4 border-b border-gray-100 pb-5">
          ...
          <div>
            <h2 className="text-lg font-bold text-primary">{user?.nama_lengkap || 'Siswa'}</h2>
            <p className="text-sm text-gray-500 capitalize">Role: {user?.role || 'Siswa'}</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
          <div>
            <span className="block text-gray-400 font-medium mb-1">NIM / NISN</span>
