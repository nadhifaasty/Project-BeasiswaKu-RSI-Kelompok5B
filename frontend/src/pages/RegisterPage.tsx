...
function RegisterPage() {
  ...
  return (
    <section className="max-w-lg mx-auto px-4 py-16">
      <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">Pendaftaran Akun</h1>
      ...
      <form className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            <input type={showPassword ? 'text' : 'password'} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Minimal 8 karakter" />
        ...
        <div>
          ...
          <div className="relative">
            <input type={showConfirm ? 'text' : 'password'} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ulangi kata sandi" />
        ...
        <label className="flex items-start gap-2 text-sm">
          ...
          <span className="text-gray-600">Saya menyetujui <a href="#" className="text-blue-600 hover:underline">syarat dan ketentuan</a> yang berlaku.</span>
        </label>
