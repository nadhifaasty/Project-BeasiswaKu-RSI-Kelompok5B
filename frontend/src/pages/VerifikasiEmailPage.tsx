  ...
  return (
    <section className="max-w-md mx-auto px-4 py-16 text-center">
      <div className="bg-white border rounded-xl p-8 shadow-sm">
        ...
        <h1 className="text-2xl font-bold text-primary mb-2">Verifikasi Email</h1>
        ...
        <button
          ...
          disabled={cooldown > 0}
          className="bg-accent text-white px-6 py-2.5 rounded-lg font-medium hover:bg-accent-light transition disabled:bg-gray-300 disabled:cursor-not-allowed"
        >
        ...
        <div className="mt-6 pt-4 border-t">
          <Link to="/login" className="text-accent text-sm hover:underline">Kembali ke Login</Link>
        </div>
      </div>
    </section>
  )
