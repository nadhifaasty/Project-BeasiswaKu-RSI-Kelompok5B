      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <ul className="flex items-center gap-6 text-sm font-medium">
            ...
            <li><Link to="/#program" className="text-gray-700 hover:text-blue-600">Program Beasiswa</Link></li>
            <li><Link to="/#berita" className="text-gray-700 hover:text-blue-600">Berita</Link></li>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/#program" className="hover:text-white">Program Beasiswa</Link></li>
